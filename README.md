This repository contains data and source code for demonstrating purposes using capture-recapture to estimate the number of homeless people in Hungary (1996-1998).
----
